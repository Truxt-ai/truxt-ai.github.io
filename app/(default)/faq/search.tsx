        ...
        <div>
            ...
            >
                <div className='flex items-center justify-center'>
                    <svg className='mr-3 h-4 w-4 shrink-0 fill-gray-500' width={16} height={16} viewBox='0 0 16 16' xmlns='http://www.w3.org/2000/svg'>
                    ...
                    <span>
                        Search
                        <span className='hidden sm:inline'> help (e.g., creating a site, members, etc.) </span>…
                    </span>
                </div>
                <div className='ml-3 flex gap-1'>
                    <div className='flex h-6 w-6 items-center justify-center rounded bg-white text-gray-400 shadow-sm'>
                        <svg className='fill-current' xmlns='http://www.w3.org/2000/svg' width={11} height={12} fill='none'>
                    ...
                    <div className='flex h-6 w-6 items-center justify-center rounded bg-white text-gray-400 shadow-sm'>
                        <svg className='fill-current' xmlns='http://www.w3.org/2000/svg' width={8} height={9} fill='none'>
