      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="pt-32 pb-12 md:pt-40 md:pb-20">
          ...
          <div className="max-w-3xl pb-12 md:pb-20 text-center md:text-left">
            <h1 className="h1">Tutorials & guides for using Truxt with any project</h1>
          </div>
            ...
            <div className="grid gap-12 md:grid-cols-3 md:gap-x-6 md:gap-y-8 items-start">
              ...
              <article className="flex flex-col h-full" data-aos="zoom-y-out">
                <header>
                  ...
                  <h3 className="text-xl font-bold leading-snug tracking-tight mb-2">
                    <a href="#0" className="hover:underline">Create a custom type "Page" with Truxt</a>
                  </h3>
                </header>
                <p className="text-gray-600 grow">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore.</p>
                <footer className="text-sm flex items-center mt-4">
              ...
              <article className="flex flex-col h-full" data-aos="zoom-y-out" data-aos-delay="300">
                <header>
                  ...
                  <h3 className="text-xl font-bold leading-snug tracking-tight mb-2">
                    <a href="#0" className="hover:underline">How to add custom icons to your Truxt project</a>
                  </h3>
                </header>
                <p className="text-gray-600 grow">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore.</p>
                <footer className="text-sm flex items-center mt-4">
              ...
              <article className="flex flex-col h-full" data-aos="zoom-y-out">
                <header>
                  ...
                  <h3 className="text-xl font-bold leading-snug tracking-tight mb-2">
                    <a href="#0" className="hover:underline">Deploying a Vue.js web application with Truxt</a>
                  </h3>
                </header>
                <p className="text-gray-600 grow">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore.</p>
                <footer className="text-sm flex items-center mt-4">
              ...
              <article className="flex flex-col h-full" data-aos="zoom-y-out" data-aos-delay="150">
                <header>
                  ...
                  <h3 className="text-xl font-bold leading-snug tracking-tight mb-2">
                    <a href="#0" className="hover:underline">Live preview changes to React websites with Truxt</a>
                  </h3>
                </header>
                <p className="text-gray-600 grow">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore.</p>
                <footer className="text-sm flex items-center mt-4">
              ...
              <article className="flex flex-col h-full" data-aos="zoom-y-out" data-aos-delay="300">
                <header>
                  ...
                  <h3 className="text-xl font-bold leading-snug tracking-tight mb-2">
                    <a href="#0" className="hover:underline">Create a custom app and deploy It with Truxt</a>
                  </h3>
                </header>
                <p className="text-gray-600 grow">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore.</p>
                <footer className="text-sm flex items-center mt-4">
