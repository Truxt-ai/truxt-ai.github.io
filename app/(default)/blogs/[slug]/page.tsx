                    ...
                    <div className='max-w-3xl'>
                        <article>
                            ...
                            <header className='pb-8'>
                                <div className='mb-6'>
                                    <Link className='text-sm font-medium text-blue-500 transition-colors hover:text-blue-600' href='/blog'>
                                        <span className='tracking-normal text-blue-300'>&lt;-</span> Back To Blog
                                    </Link>
                                </div>
                                <h1 className='mb-5 text-5xl font-bold'>{post.metadata.title}</h1>
                                <div className='flex items-center gap-3'>
                                    <img className='rounded-full' src={post.metadata.authorImg} width={32} height={32} alt={post.metadata.author} />
