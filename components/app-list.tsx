...
export default function AppList() {
    const apps01 = [
        {
            name: 'Google Drive',
            description: 'Truxt simplifies the process of building sites, landing pages, and any apps.',
        ...
        <section>
            <div className='mx-auto max-w-6xl px-4 sm:px-6'>
                <div className='pb-12 md:pb-20'>
                    {/* Categories */}
                    {/* <div className='pb-12 md:pb-20 hidden'>
                        <div className='flex flex-wrap justify-center gap-2'>
                            <button className='btn-sm bg-gray-800 font-normal text-gray-200 shadow hover:bg-gray-900'>
                                <svg className='mr-2 fill-gray-500' xmlns='http://www.w3.org/2000/svg' width={16} height={16}>
                            ...
                            <button className='btn-sm bg-white font-normal text-gray-800 shadow hover:bg-gray-50'>
                                <svg className='mr-2 fill-gray-400' xmlns='http://www.w3.org/2000/svg' width={16} height={16}>
                    ...
                    <div className='space-y-10'>
                        ...
                        <section>
                            <div className='mb-5 flex items-center justify-between space-x-2'>
                                ...
                                <a className='shrink-0 text-sm font-medium text-blue-500 transition hover:text-blue-600' href='#0'>
                                    View All
                                </a>
                            </div>
