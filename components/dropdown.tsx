...
export default function Dropdown({ children, title }: DropdownProps) {
    ...
    return (
        <ul>
            <li className='relative flex items-center gap-0.5 py-1' onMouseEnter={() => setDropdownOpen(true)} onMouseLeave={() => setDropdownOpen(false)}>
