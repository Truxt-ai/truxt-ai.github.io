  ...
  const offerings = [
    {
      ...
      features: [
        'Pretrained GenAi model for higher accuracy',
        'Org Private data remains private',
        'Scales seamlessly with large datasets as well',
    ...
    },
    {
      ...
      features: [
        'Built for Open Source DevOps Technical Support',
        'DevOps trained/fine-tuned models',
        'Instant Technical Issue Resolution',
        'Agentic AI Troubleshooting, for Your Orgs Environment'
      ]
    }
  ]
      ...
      <div className="container mx-auto max-w-7xl">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-muted-foreground">
            Discover how Truxt can revolutionize your organization's knowledge management and customer support
          </p>
        </div>
