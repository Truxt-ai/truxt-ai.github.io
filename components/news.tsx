      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2">The most innovative businesses choose Truxt</h2>
          </div>
            ...
            <div className="grid gap-12 md:grid-cols-3 md:gap-x-6 md:gap-y-8 items-start">
              ...
              <article className="flex flex-col h-full" data-aos="zoom-y-out">
                <header>
                  ...
                  <h3 className="text-xl font-bold leading-snug tracking-tight">
                    <a href="#0" className="hover:underline">“How HubSpot saved 25% on developing costs by switching to Truxt.”</a>
                  </h3>
                </header>
              ...
              <article className="flex flex-col h-full" data-aos="zoom-y-out" data-aos-delay="150">
                <header>
                  ...
                  <h3 className="text-xl font-bold leading-snug tracking-tight">
                    <a href="#0" className="hover:underline">“How Facebook brought 13% cost savings to their bottom line with Truxt’s products.”</a>
                  </h3>
                </header>
                <footer className="text-sm flex items-center mt-4">
                  <div className="flex shrink-0 mr-3">
              ...
              <article className="flex flex-col h-full" data-aos="zoom-y-out" data-aos-delay="300">
                <header>
                  ...
                  <h3 className="text-xl font-bold leading-snug tracking-tight">
                    <a href="#0" className="hover:underline">“How Tinder grew 115% and saved 120 Hours each week by outsourcing to Truxt.”</a>
                  </h3>
                </header>
                <footer className="text-sm flex items-center mt-4">
                  <div className="flex shrink-0 mr-3">
