    ...
    return (
        <div className='p-4 border-t border-gray-200'>
            ...
            <DropdownMenu>
                ...
                <button
                    className={cn('rounded-full bg-primary group hover:bg-gray-300 transition-all duration-200 dark:bg-darkGray', 'p-1', 'p-2', 'dark:bg-darkGray dark:text-white')}
                    onClick={() => {
                        sendMessage(textAreaInputValue);
                    }}
                >
                    {inputDisabled ? <Square role='icon' className='size-4 invert group-hover:invert-0 dark:invert-0' /> : <ArrowRight role='icon' className='size-5 invert dark:invert-0 group-hover:invert-0' />}
                </button>
            </div>
