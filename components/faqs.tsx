...
export default function Faqs() {
  const faqs = [
    {
      question: "How is Truxt different from Complex?",
      answer:
        "Truxt is designed to be user-friendly and intuitive, while Complex is more robust and feature-rich. Both tools are great for creating websites, but Truxt is ideal for beginners and small businesses, while Complex is better suited for larger organizations and developers.",
    },
    {
    ...
    {
      question: "What kind of support does Truxt provide?",
      answer:
    ...
    {
      question: "How much traffic can Truxt hosting handle?",
      answer:
    ...
    {
      question: "Are Truxt websites SEO-friendly?",
      answer:
        "Yes! Truxt websites are designed with SEO in mind, so you can easily optimize your site for search engines.",
    },
  ];
