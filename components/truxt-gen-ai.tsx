            ...
            <section className='py-7' data-aos='zoom-y-out' data-aos-delay={400}>
                <div className='mx-auto max-w-6xl px-4 sm:px-4'>
                    <div className='relative rounded-lg overflow-hidden shadow-xl'>
                        <Image src='/images/truxt-gen-ai.png' alt='Truxt Gen AI Enablement' width={800} height={400} className='w-full h-auto object-cover' />
                        <div className='absolute inset-0 bg-gradient-to-r from-primary/50 to-transparent flex items-center'>
                            <div className='p-8'>
                                ...
                                <p className='text-white text-lg max-w-md'>Truxt GenAI and DevOpsGPT revolutionize enterprise operations with cutting-edge AI solutions.</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <li>Analytics on resolutions and trends.</li>
                            ...
                            <Card className='p-6 bg-gradient-to-t from-blue-600 to-blue-500'>
                                <CardContent>
                                    ...
                                    <p className='mb-6 text-white'>Experience the future of AI-enabled organizations. Contact our team to schedule your personalized demo today.</p>
                                    <Link href='/contact-us' className='inline-block bg-white text-primary font-semibold py-2 px-4 rounded-md hover:bg-gray-100 transition-colors'>
                                        Request demo
                                    </Link>
                                </CardContent>
                            </Card>
